  ...
  .then(({ data, error }) => {
    ...
    csvPrices = data.map((watch) => {
      ...
      if (watch.reference.startsWith("126710")) {
        ...
        image: String(watch.image_url || "").replace(/\s+/g, "") || image,
